"""GPT-audio inference wrapper for distributed phone transcription."""
...
class GptAudioInference:
    """Distributed-inference-compatible GPT-audio transcription wrapper."""
        ...
        try:
            ...
            if self.error_log_path:
                self._append_jsonl(
                    ...
                    {
                        "key": cache_key,
                        "audio_path": str(kwargs.get("audio_path") or kwargs.get("wavpath") or ""),
                        "error": err,
                    },
                )
            return pred
