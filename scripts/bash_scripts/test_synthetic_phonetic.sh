#!/usr/bin/env bash
#SBATCH -J test_synthetic_phonetic_all_eval
#SBATCH -p gpu_test
#SBATCH --gres=gpu:1
#SBATCH -c 8
#SBATCH --mem=48G
...
# Run PRiSM models on test_synthetic_phonetic (Kaldi-style eval set), then score PER + inventory.
# Submit:  sbatch /n/iqss_sponsored/Lab/zshi/PhonBenchDev/scripts/bash_scripts/test_synthetic_phonetic.sh
